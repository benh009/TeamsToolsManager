...
class ClubController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clubs = $em->getRepository('OCPlatformBundle:Club')->findAll();
    ...
    {
        $club = new Club();
        $form = $this->createForm('OC\PlatformBundle\Form\ClubType', $club);
    ...
    {
        $deleteForm = $this->createDeleteForm($club);
        $editForm = $this->createForm('OC\PlatformBundle\Form\ClubType', $club);
