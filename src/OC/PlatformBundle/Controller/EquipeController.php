...
class EquipeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $equipes = $em->getRepository('OCPlatformBundle:Equipe')->findAll();
    ...
    {
        $equipe = new Equipe();
        $form = $this->createForm('OC\PlatformBundle\Form\EquipeType', $equipe);
    ...
    {
        $deleteForm = $this->createDeleteForm($equipe);
        $editForm = $this->createForm('OC\PlatformBundle\Form\EquipeType', $equipe);
