...
class CoachController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $coaches = $em->getRepository('OCPlatformBundle:Coach')->findAll();
    ...
    {
        $coach = new Coach();
        $form = $this->createForm('OC\PlatformBundle\Form\CoachType', $coach);
    ...
    {
        $deleteForm = $this->createDeleteForm($coach);
        $editForm = $this->createForm('OC\PlatformBundle\Form\CoachType', $coach);
