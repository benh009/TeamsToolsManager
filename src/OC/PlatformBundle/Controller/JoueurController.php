...
class JoueurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $joueurs = $em->getRepository('OCPlatformBundle:Joueur')->findAll();
    ...
    {
        $joueur = new Joueur();
        $form = $this->createForm('OC\PlatformBundle\Form\JoueurType', $joueur);
    ...
    {
        $deleteForm = $this->createDeleteForm($joueur);
        $editForm = $this->createForm('OC\PlatformBundle\Form\JoueurType', $joueur);
